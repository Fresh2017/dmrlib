...
extern char *  dmr_dpf_name(dmr_dpf dpf);
extern char *  dmr_sap_name(dmr_sap sap);
extern int     dmr_data_header_decode(dmr_packet packet, dmr_data_header *header, dmr_data_type data_type);
extern int     dmr_data_block_decode(dmr_packet packet, dmr_data_block *block, bool confirmed, dmr_data_type data_type);
extern uint8_t dmr_data_block_size(dmr_data_rate rate, bool confirmed);
