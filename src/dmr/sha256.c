...
#define S0(x) (rotr_fixed(x, 2) ^ rotr_fixed(x,13) ^ rotr_fixed(x, 22))
#define S1(x) (rotr_fixed(x, 6) ^ rotr_fixed(x,11) ^ rotr_fixed(x, 25))
#define s0(x) (rotr_fixed(x, 7) ^ rotr_fixed(x,18) ^ (x >> 3))
#define s1(x) (rotr_fixed(x,17) ^ rotr_fixed(x,19) ^ (x >> 10))
